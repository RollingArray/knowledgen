 ...
 *
 *
 * @summary Course content coverage component
...
@Component({
	selector: 'course-content-coverage',
	templateUrl: './course-content-coverage.component.html',
	styleUrls: ['./course-content-coverage.component.scss'],
})
export class CourseContentCoverageComponent extends BaseFormComponent implements OnInit
{
	/**
	 * -------------------------------------------------|
	 * @description										|
	...
	/**
	 * Description  of course content coverage component
	 */
	...
	/**
	 * Creates an instance of course content coverage component.
	 * @param injector 
	...
	{
		this._chartLabels = [];
		dashboardStudentModel.courseContentCoverageOverTime.map((eachDate, index) =>
		{
			this._chartLabels = [
				eachDate.month,
				...this._chartLabels
				...
				this._chartOptions = {
					...
					scales: {
						...
						y: {
							...
							title: {
								display: true,
								text: `${data['formInfo.courseContentCovered']}`,
								color: '#003566'
							},
							ticks: {
								color: '#003566'
