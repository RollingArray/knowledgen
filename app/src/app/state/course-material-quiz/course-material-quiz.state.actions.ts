 ...
 * Last modified  : 2022-07-13 20:10:35
 */
...
/**
 * @description Availability planner actions - Api Request Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Loaded Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Act Upon Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Send Api Request To Add New Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Send Api Request To Edit Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Send Api Request To Delete Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Store Newly Added Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Store Updated Course Material Quiz
 */
...
/**
 * @description Availability planner actions - Remove Course Material Quiz From Store
 */
...
/**
 * @description Availability planner actions - Course Material Quiz CRUD Successfully
 */
...
/**
 * @description Availability planner actions - Course Material Quiz CRUD Fail
 */
...
/**
 * @description Availability planner actions - Course Material Quiz Updated Successfully
 */
...
/**
 * @description Availability planner actions - Course Material Quiz Deleted Successfully
 */
...
/**
 * @description Availability planner actions - Course Material Quiz Added Successfully
 */
