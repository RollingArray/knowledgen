...
***This is a mono repository holding all the source code for client and server. Follow the root folder structure to navigate inside app and api repository  
